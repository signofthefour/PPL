...
var_init: ( ID (LEFT_BRACKET INT_LIT RIGHT_BRACKET)+ | scalar_var) ASSIGN (composite_data | primitive_data);
...
assign_stmt: (composite_var | scalar_var) ASSIGN (expr);
break_stmt: BREAK;
...
expr3: expr3 (STAR_INT | STAR_FLOAT | DIV_FLOAT |  DIV_INT | MOD) expr4 | expr4;

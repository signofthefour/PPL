...
public interface BKITListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link BKITParser#bool_array}.
	 * @param ctx the parse tree
	 */
	void enterBool_array(BKITParser.Bool_arrayContext ctx);
	/**
	 * Exit a parse tree produced by {@link BKITParser#bool_array}.
	 * @param ctx the parse tree
	 */
	void exitBool_array(BKITParser.Bool_arrayContext ctx);
	/**
